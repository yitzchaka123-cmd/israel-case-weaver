...
If the user asks you to generate the Logic Flow from chat, you cannot directly call the canvas generator tool yet; tell them to open Canvas → Logic Flow and click Generate, then approve it. After approval, you can create the Final Flow from chat.

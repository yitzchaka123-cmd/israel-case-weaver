...
- Envelope #0 ("${labels[0]}") is the MISSION BRIEFING — opened first. It introduces the case, the detective's role, the victim, the location, and the time window. Its opening trigger is the equivalent of "Open first, before reading anything else." HARD RULE: NEVER mention "Doc 0", "Document 0", a contents list, a case-file index, a table of contents, or instruct the player to read any specific document. The case file is just "the case file in front of you" — never named items.
